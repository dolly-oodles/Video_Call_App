...
const MessageContainer = ({ onBackUser }) => {
  ...
  return (
    <div className="w-full h-full flex flex-col py-6 px-3 ">
      {selectedConversation === null ? (
        ...
        <>
          <div className="flex justify-between gap-1 py-2 bg-sky-600 md:px-2 rounded-lg">
          ...
          <form onSubmit={handleSubmit} className=" rounded-full text-black">
            <div className="w-[80%] mx-auto relative rounded-full flex items-center bg-white">
              <input
                value={sendData}
                required
                ...
                id="message"
                type="text "
                className="w-full bg-transparent outline-none pl-3 py-[0.6rem] rounded-full"
                placeholder="Message"
              />
              <button type="submit" className=" right-[2px] absolute">
                {loading ? (
                  <div className="loading loading-spinner "></div>
                ) : (
                  <IoSend
                    size={25}
                    className="text-sky-600 cursor-pointer rounded-full bg-black w-10 h-auto p-2"
                  />
                )}
              </button>
            </div>
